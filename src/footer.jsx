      ...
      <div className="max-w-screen-xl mx-auto px-8">
        <div className="flex justify-between items-center text-lg font-semibold text-white animate__animated animate__fadeIn animate__delay-1s">
          ...
          <div className="flex space-x-8">
            <a href="https://www.instagram.com" className="text-white hover:text-orange-400 transition duration-300 ease-in-out transform hover:scale-125">
              <FaInstagram size={28} />
            </a>
            <a href="https://www.linkedin.com" className="text-white hover:text-orange-400 transition duration-300 ease-in-out transform hover:scale-125">
              <FaLinkedin size={28} />
            </a>
            <a href="https://www.twitter.com" className="text-white hover:text-orange-400 transition duration-300 ease-in-out transform hover:scale-125">
              <FaTwitter size={28} />
            </a>
          </div>
        </div>
        ...
        <div
          className={`mt-10 p-8 bg-white text-black rounded-2xl shadow-xl transform transition-all duration-700 ease-in-out ${isVisible ? 'translate-x-0' : '-translate-x-full'} animate__animated animate__fadeIn`}
        >
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
            {/* Address */}
            <div className="space-y-4">
              <h3 className="text-xl font-semibold text-gray-800">Our Address:</h3>
              <p className="text-sm text-gray-600">123 Business Avenue, Tech City, XYZ Country</p>
            </div>
