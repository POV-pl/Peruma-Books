  ...
  const workshops = [
    {
      ...
      description: "Intensive 3-day bootcamp covering modern web development technologies including React, Node.js, and MongoDB. Perfect for beginners and intermediate developers looking to upgrade their skills.",
    ...
    },
    {
      ...
      images: [
        "wok2.png",
        "../workshops/ai-ml-2.png"
      ],
      description: "Deep dive into artificial intelligence and machine learning fundamentals. Learn about neural networks, deep learning, and practical applications in industry.",
      date: "April 5-6, 2025",
      capacity: 25,
      duration: "2 days",
    ...
    },
    {
      ...
      description: "Master the art of user experience design. Learn about user research, wireframing, prototyping, and modern design tools used in industry.",
      date: "April 20, 2025",
      capacity: 20,
      duration: "1 day",
      ...
      <main className="flex-1">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
              ...
              {workshops.map((workshop, index) => (
                ...
                >
                  ...
                  >
                    ...
                    <div className="p-4">
                      <h3 className="font-semibold text-lg text-gray-800 mb-2">{workshop.title}</h3>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6 mb-12">
            {[
              { icon: Users, title: "Total Participants", value: "500+", color: "blue" },
              { icon: Calendar, title: "Workshops", value: workshops.length, color: "green" },
              { icon: Clock, title: "Hours of Content", value: "100+", color: "blue" },
...
>
  ...
  <p className="text-gray-600 leading-relaxed text-justify">
              Our workshops are designed to provide immersive, hands-on learning experiences led by industry experts. 
              Each workshop combines theoretical knowledge with practical applications, ensuring participants gain 
              real-world skills they can immediately apply in their careers. From cutting-edge technology to design 
              and innovation, our diverse range of workshops caters to professionals at all levels seeking to advance 
              their expertise and stay ahead in their fields
  </p>
</div>
</div>
</main>
          ...
          <div className="bg-white rounded-2xl p-6 max-w-4xl w-full mx-auto max-h-[90vh] overflow-y-auto">
            <div className="flex flex-col space-y-6">
              <div className="flex justify-between items-start">
                <div>
                  <h2 className="text-3xl font-bold text-gray-800">{selectedWorkshop.title}</h2>
                  <p className="text-xl text-gray-600 mt-1">by {selectedWorkshop.instructor}</p>
                </div>
                <button
                ...
                <div>
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center gap-3">
                      ...
                      <span className="text-gray-700">{selectedWorkshop.date}</span>
                    </div>
                    <div className="flex items-center gap-3">
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <span className="text-gray-700">{selectedWorkshop.capacity} participants max</span>
                    </div>
                  </div>
                </div>
